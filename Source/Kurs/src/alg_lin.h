#ifndef ALG_NLIN_H_INCLUDED
#define ALG_NLIN_H_INCLUDED
...
/**
 * @brief Class for calculation linear equation of shallow water
 *
 * @detailed This class contains specific for linear equations functionali
 */
class AlgLin : public Alg{
    /**
     * not used
     */
    double ret[3];
     ...
     */
    AlgLin(double in_height,double in_lenght,int in_nx,int in_ny,double in_eps,char *in_out_name, int in_count, double in_t):Alg(in_height,in_lenght,in_nx,in_ny,in_eps,in_out_name,in_count,in_t){};
